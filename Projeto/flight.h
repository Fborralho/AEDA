...
public:
    Flight(int n, int fli_du, string dd, string ad, string cd, string ca): num_flight(n), flight_dur(fli_du), departure_date(dd), arrival_date(ad), city_departure(cd), city_arrival(ca){}
    int getDuration();
